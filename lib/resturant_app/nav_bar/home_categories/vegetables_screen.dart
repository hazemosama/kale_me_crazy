...
class VegetablesScreen extends StatelessWidget {
              ...
              child: SingleChildScrollView(
                ...
                child: ConditionalBuilder(
                  builder: (context) => homeProductsBuilder(
                      cubitH.userModel!, cubitH.homeModel!, context),
  ...
  Widget homeProductsBuilder(
          UserModel user, HomeAndCategoryModel model, context) =>
        ...
        GridView.count(
          ...
          children: List.generate(
              ...
              (index) => buildGridProduct(
                  model.data.category.elementAt(0).products.product[index],
                  context)),
        )
      ]);
            ...
            InkWell(
              onTap: () {
                HomeCubit.get(context)
                    .getProductDetails(productId: '${model.id}');
